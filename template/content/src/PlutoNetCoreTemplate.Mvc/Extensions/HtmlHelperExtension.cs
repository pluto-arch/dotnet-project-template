...
namespace PlutoNetCoreTemplate.Mvc.Extensions
{
    public static class HtmlHelperExtension
    {
        ...
        /// <returns></returns>
        public static string MenuActiveClass(this IHtmlHelper htmlHelper, string controllers = null, string actions = null, string cssClass = "active")
        {
